const installText = `
For this setup to work the Mediumroast GitHub application must be installed at
...
URL: https://github.com/marketplace/mediumroast-for-github

A more detailed product description, help and other related documentation can be found 
here: https://www.mediumroast.io/.

NOTICE: This setup installs two GitHub Actions, and their associated workflows, into 
the repository that it creates.  These Actions consume GitHub Actions minutes and may incur 
charges to your GitHub account if you are over allowed free actions for your plan.  
