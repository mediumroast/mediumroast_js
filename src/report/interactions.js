...
class BaseInteractionsReport {
    ...
    protorequirementsTable(topics) {
        ...
        if (Object.keys(topics).length === 0) {
            return this.textWidgets.makeParagraph('No proto-requirements or competitive insights were discovered or are associated to this interaction.')
        }
        ...
        let myRows = [
            new docx.TableRow({
                children: [
                    ...
                    new docx.TableCell({
                        children: [this.textWidgets.makeParagraph(insightsColumnHeader, {bold: true, fontSize: this.generalStyle.tableFontSize})],
                        borders: this.bottomBorder,
                        margins: {
                            top: this.generalStyle.tableMargin
                        },
            ...
            myRows.push(
                new docx.TableRow({
                    children: [
                        ...
                        new docx.TableCell({
                            children: [this.textWidgets.makeParagraph(
                                String(topics[topic][insightsCellKey]), 
                                {fontSize: this.generalStyle.tableFontSize})
                            ],
                            borders: this.bottomBorder,
                            margins: {
    ...
    makeReferencesDOCX(isPackage, bookmark={}) {
        ...
        for (const interaction in this.interactions) {
            ...
            references.push(
                ...
                tagsTable,
                this.textWidgets.makeHeading2(insightsTableHeader),
...
class InteractionStandalone extends BaseInteractionsReport {
    ...
    constructor(interaction, company, env, allObjects, author='Mediumroast for GitHub') {
        ...
        this.introduction = 'This document was automatically generated by Mediumroast for GitHub.' +
            ' It includes an abstract, tags and proto-requirements/competitive insights for this Interaction.' + 
    ...
    async makeDOCX(fileName, isPackage) {
        ...
        const myDocument = [].concat(
            ...
            [
                ...
                this.textWidgets.makeHeading1(insightsTableHeader),
